...
GI_C_DEPENDS:=Json.c BlockAllocator.c gi_main.c gi_PositionValue.c gi_OffencePlay.c gi_Player.c gi_Team.c gi_PlayInfo.c gi_GlobalInfo.c gi_SpecialTeamsValues.c
GI_CPP_DEPENDS:=
C_PROJECTS:=gi
